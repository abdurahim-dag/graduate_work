...
with DAG(
    ...
    groups_extract = []
    for script in [
        'run_extractor_film_work',
        'run_extractor_genre',
        'run_extractor_person',
        'run_extractor_genre_film_work',
        'run_extractor_person_film_work',
    ]:
        task = BashOperator(
            task_id=script,
            cwd='/opt/airflow/src',
    ...
    t_upload_to_es = BashOperator(
        ...
        params={'host': es_host, 'port': es_port, 'dir_path': dir_path},
        dag=dag,
    )
